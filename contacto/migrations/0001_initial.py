    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('campo_extra', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='campo_grupo', to='contacto.CampoExtra')),
                ('grupo', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='gupo_campo', to='contacto.Grupo')),
            ],
            options={
                'ordering': ['grupo'],
            },
